...
const recent = [
  { label: "Payments Graph", meta: "Generated 2m ago · Ready" },
  { label: "Auth Middleware Update", meta: "Generated 12m ago · Preview" },
  { label: "Infra Sandbox", meta: "Provisioned 45m ago · Deployed" },
];

const projects = [
  { id: "p1", name: "Payments Graph", updatedAt: "2m ago", status: "Active" },
  {
    id: "p2",
    name: "Async API Playground",
    updatedAt: "Yesterday",
    status: "Draft",
  },
  {
